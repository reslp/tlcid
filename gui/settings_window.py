from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QLabel, QComboBox, QPushButton, QDoubleSpinBox)
from PyQt6.QtCore import Qt, pyqtSignal

class SettingsWindow(QWidget):
    settingsChanged = pyqtSignal(str, float)
    ...
    def emit_settings(self):
        ...
        self.settingsChanged.emit(method, range_val)

    def set_current_settings(self, method, range_val):
